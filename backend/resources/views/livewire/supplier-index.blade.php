                            ...
                            <div class="flex items-center justify-center gap-1.5">
                                ...
                                @else
                                    ...
                                    <button 
                                        ...
                                        class="px-2 py-1 bg-emerald-500/10 hover:bg-emerald-600 text-emerald-700 dark:text-emerald-300 hover:text-white rounded-lg text-xs font-bold border border-emerald-500/30 transition-all inline-flex items-center gap-1 cursor-pointer"
                                    >
                                        <span>💵</span>
                                    </button>
                                    @endcan
                                    ...
                                    <a 
                                        ...
                                        class="px-2 py-1 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-lg text-xs font-bold border border-slate-300 dark:border-slate-700 transition-colors inline-flex items-center gap-1"
                                    >
                                        <span>📑</span>
                                    </a>
                                    @endcan
