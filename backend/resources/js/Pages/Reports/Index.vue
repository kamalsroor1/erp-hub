...
<template>
    ...
    <AppLayout>
        <div class="space-y-6 font-tajawal">
            ...
            <!-- 7 Navigation Tabs -->
            <div class="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-2 bg-slate-100 dark:bg-slate-950 p-1.5 rounded-2xl border border-slate-200 dark:border-slate-800 text-xs">
                <button
                    v-for="tab in [
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-5 space-y-2 shadow-xs">
                        ...
                        <div class="text-2xl font-black font-mono text-indigo-600 dark:text-indigo-300">
                            {{ formatMoney(summary.total_cogs) }} <span class="text-xs font-bold text-slate-700 dark:text-white">{{ $t('common.currency') }}</span>
                        </div>
                        <div class="text-[11px] text-slate-500 dark:text-slate-400 font-bold">
                    ...
                    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-5 space-y-2 shadow-xs">
                        ...
                        <div class="text-2xl font-black font-mono text-emerald-600 dark:text-emerald-400">
                            {{ formatMoney(summary.gross_profit) }} <span class="text-xs font-bold text-slate-700 dark:text-white">{{ $t('common.currency') }}</span>
                        </div>
                        <div class="text-[11px] text-slate-500 dark:text-slate-400 font-bold">
                    ...
                    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-5 space-y-2 shadow-xs">
                        ...
                        <div class="text-2xl font-black font-mono" :class="summary.net_profit >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-rose-600 dark:text-rose-400'">
                            {{ formatMoney(summary.net_profit) }} <span class="text-xs font-bold text-slate-700 dark:text-white">{{ $t('common.currency') }}</span>
                        </div>
                        <div class="text-[11px] text-slate-500 dark:text-slate-400 font-bold">
            ...
            <!-- TAB 2: ITEM PROFITS -->
            <div v-if="currentTab === 'items'" class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 space-y-4 shadow-xs">
            ...
            <div v-if="currentTab === 'stores'" class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 space-y-4 shadow-xs">
            ...
            <div v-if="currentTab === 'customers'" class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 space-y-4 shadow-xs">
                <div class="flex items-center justify-between border-b border-slate-200 dark:border-slate-800 pb-3">
