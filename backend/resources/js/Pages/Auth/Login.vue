...
<template>
    ...
    <div class="min-h-screen bg-slate-950 text-slate-100 flex items-center justify-center p-4 sm:p-6 relative overflow-hidden font-sans selection:bg-emerald-500 selection:text-white">
        ...
        <div class="w-full max-w-md bg-slate-900/90 backdrop-blur-2xl border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6 relative z-10">
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div class="pt-2">
                    ...
                    >
                        <span v-if="!form.processing">🚀 {{ $t('auth.login_button') }}</span>
            ...
            <div class="p-4 bg-slate-950/60 border border-slate-800 rounded-2xl space-y-2 text-xs">
                ...
                <div class="grid grid-cols-1 gap-2 pt-1">
                    <button
                        ...
                        class="w-full flex items-center justify-between p-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700/60 text-right transition-colors cursor-pointer group"
                    >
                        <div>
                            <p class="font-bold text-white group-hover:text-amber-400 transition-colors">👑 {{ $t('auth.super_admin_1') }}</p>
                    ...
                    >
                        <div>
                            <p class="font-bold text-white group-hover:text-amber-400 transition-colors">👑 {{ $t('auth.super_admin_2') }}</p>
