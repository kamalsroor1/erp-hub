            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
                ...
                <div class="space-y-3">
                    ...
                    <div class="space-y-2">
                        ...
                        >
                            <div>
                                <h3 class="font-black text-xs">
                                    {{ r.label }}
                                </h3>
                                <span class="text-[10px] opacity-75 font-bold mt-0.5 block">
                                    {{ $t('roles.active_permissions_count', { count: r.permissions_count }) }}
                                </span>
                            </div>
                            <span v-if="selectedRoleId === r.id" class="font-black">←</span>
                        </button>
                    </div>
                </div>
                    ...
                    <div class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 shadow-xs space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div
                                ...
                                :key="modKey"
                                class="bg-slate-50 dark:bg-slate-950/70 border border-slate-200 dark:border-slate-800/80 rounded-2xl p-4 space-y-3"
                            >
                                ...
                                <div class="space-y-2">
                                    <label
                                        ...
                                        :key="permKey"
                                        class="flex items-start gap-3 p-2 rounded-xl hover:bg-slate-100 dark:hover:bg-slate-900/60 transition cursor-pointer"
                                    >
                                        <input
                                            type="checkbox"
                                            ...
                                            class="rounded accent-theme-primary focus:ring-0 mt-0.5 cursor-pointer"
                                        >
