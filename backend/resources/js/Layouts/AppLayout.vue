...
<template>
    <div class="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-amber-500 selection:text-white" dir="rtl">
            ...
            <div class="flex items-center gap-2 sm:gap-3">
                ...
                <div class="relative" @click.stop>
                    <button
                        ...
                        type="button"
                        class="flex items-center gap-2 p-1.5 pr-2.5 rounded-xl bg-slate-800/80 hover:bg-slate-800 border border-slate-700 transition cursor-pointer"
                    >
                        ...
                        <span class="text-xs font-bold text-slate-200 hidden lg:inline max-w-[120px] truncate">
                            {{ user.name }}
                        </span>
                    ...
                    <div
                        v-if="showUserMenu"
                        class="absolute left-0 mt-2 w-56 bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl p-2 z-50 space-y-1 font-tajawal"
                    >
        ...
        <div class="flex-1 flex overflow-hidden">
            ...
            <aside
                id="main-sidebar"
                class="fixed inset-y-0 right-0 z-50 bg-slate-900 border-l border-slate-800 flex flex-col shadow-xl lg:shadow-none select-none shrink-0 transition-all duration-300 lg:static"
                :class="[
            ...
            >
                <!-- Brand Header -->
                <div class="h-16 px-3.5 flex items-center justify-between border-b border-slate-800 bg-slate-900/60 overflow-hidden">
                    <div class="flex items-center gap-2.5 min-w-0">
                        <Link href="/" class="w-9 h-9 rounded-xl bg-slate-800 p-1 flex items-center justify-center shadow-md shadow-amber-500/10 border border-slate-700 shrink-0">
                ...
                <FeatureGate feature="pos.access">
                    <div class="p-2.5 border-b border-slate-800/80">
                        <Link
                            href="/pos"
                ...
                <div v-if="isAdmin" class="p-2.5 border-t border-slate-800 bg-slate-900/70">
                    <a
                        href="/admin/super"
            ...
            <main class="flex-1 overflow-y-auto bg-slate-950 flex flex-col p-4 sm:p-6 lg:p-8 space-y-6">
                <!-- Flash Alert Banners -->
        ...
        >
            <div @click.stop class="w-full max-w-sm bg-slate-900 border border-slate-800 rounded-3xl p-5 shadow-2xl space-y-3 font-tajawal">
                <div class="flex items-center justify-between border-b border-slate-800 pb-2.5">
                    <h3 class="font-black text-sm text-white">{{ $t('nav.select_store_modal_title') }}</h3>
                    <button @click="showStoreModal = false" class="w-7 h-7 rounded-xl bg-slate-800 text-slate-400 text-xs hover:text-white">✕</button>
                </div>
