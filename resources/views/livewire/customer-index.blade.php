                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/30 transition-colors">
                        ...
                        <td class="p-3.5 text-center">
                            <div class="flex items-center justify-center gap-2">
                                ...
                                <a href="{{ route('customers.statement', $c->id) }}" class="px-2.5 py-1 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white rounded-lg text-xs font-bold border border-slate-300 dark:border-slate-700 transition-colors">
                                    📑 كشف حساب
                                </a>
                                @if(bccomp($c->current_balance, '0.000', 3) > 0)
                                <button wire:click="openPaymentModal({{ $c->id }})" class="px-2.5 py-1 bg-emerald-500/10 hover:bg-emerald-600 text-emerald-700 dark:text-emerald-400 hover:text-white rounded-lg text-xs font-bold border border-emerald-500/30 transition-colors cursor-pointer">
                                    💵 تحصيل دفعة
                                </button>
                                @endif
                            </div>
