<div class="min-h-[85vh] flex items-center justify-center p-4 sm:p-6" x-data="{ showPass: false }">
    <div class="w-full max-w-md bg-slate-900/90 backdrop-blur-xl border border-slate-800 rounded-3xl p-6 sm:p-8 shadow-2xl space-y-6 relative overflow-hidden">
        <!-- Ambient Top Glow -->
        ...
        <div class="text-center space-y-2">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-tr from-amber-600 to-amber-400 text-white text-2xl font-black shadow-lg shadow-amber-500/30">
                ☕
            </div>
        ...
        <form wire:submit.prevent="login" class="space-y-4 font-sans">
            ...
            <div>
                <label for="phone" class="block text-xs font-bold text-slate-300 mb-1.5 font-tajawal">
                    رقم الهاتف / الموبايل <span class="text-rose-400">*</span>
                </label>
                <div class="relative">
                    <input
                        ...
                        class="w-full pr-10 pl-4 py-3 bg-slate-950/80 border border-slate-700/80 rounded-2xl text-white text-sm font-mono focus:ring-2 focus:ring-amber-500 focus:border-amber-500 focus:outline-none transition-all placeholder:text-slate-600"
                    >
                ...
                @error('phone')
                    <span class="text-xs text-rose-400 mt-1.5 block font-bold">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    <input
                        ...
                        dir="ltr"
                        placeholder="••••••••"
                        class="w-full pr-10 pl-11 py-3 bg-slate-950/80 border border-slate-700/80 rounded-2xl text-white text-sm font-mono focus:ring-2 focus:ring-amber-500 focus:border-amber-500 focus:outline-none transition-all placeholder:text-slate-600"
                    >
                    <span class="absolute inset-y-0 right-0 pr-3.5 flex items-center text-slate-400 text-sm pointer-events-none">
                        🔒
                    </span>
            ...
            <div class="flex items-center justify-between pt-1">
                <label class="flex items-center gap-2 cursor-pointer select-none">
                    ...
                    >
                    <span class="text-xs text-slate-300 font-semibold font-tajawal">تذكرني على هذا الجهاز</span>
                </label>
            </div>
        ...
        <div class="p-4 bg-slate-950/60 border border-slate-800/80 rounded-2xl space-y-2 text-xs">
            <div class="flex items-center justify-between text-slate-400 font-bold font-tajawal">
                <span>🔑 الحسابات المصرح لها (سوبر أدمن):</span>
                <span class="text-[10px] text-amber-400">انقر للتعبئة السريعة</span>
            </div>
            <div class="grid grid-cols-1 gap-2 pt-1">
                <button
                    type="button"
                    wire:click="$set('phone', '01012316954'); $set('password', 'password');"
                    class="w-full flex items-center justify-between p-2 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700/60 text-right transition-colors cursor-pointer"
                >
                    <div>
                        <p class="font-bold text-white">👑 كمال سرور (سوبر أدمن 1)</p>
                        <p class="text-[11px] text-slate-400 font-mono" dir="ltr">01012316954</p>
                    </div>
                    <span class="text-[10px] px-2 py-1 bg-amber-500/10 text-amber-400 border border-amber-500/30 rounded-lg">
                        password
                    </span>
                </button>
                ...
                >
                    <div>
                        <p class="font-bold text-white">👑 المدير العام 2 (سوبر أدمن 2)</p>
