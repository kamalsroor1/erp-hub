...
<template>
    <div class="p-2.5 rounded-2xl bg-slate-950/80 border border-slate-800 space-y-2 group hover:border-slate-700 transition">
        <div class="flex items-center justify-between gap-2">
            ...
            <div class="flex items-center gap-1 shrink-0">
                <button
                    @click="decreaseQty"
                    type="button"
                    class="w-6 h-6 rounded-lg bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs flex items-center justify-center transition cursor-pointer"
                >
                    -
                </button>
                ...
                <input
                    ...
                    type="number"
                    step="0.001"
                    class="w-14 h-6 bg-slate-900 border border-slate-700 rounded-lg text-center text-xs font-mono font-black text-amber-400 focus:outline-none focus:border-amber-500"
                />
        ...
        <div v-if="isWeightBased" class="flex items-center gap-1 pt-1 border-t border-slate-900 text-[10px]">
            ...
            <button
                ...
                type="button"
                class="px-2 py-0.5 rounded bg-slate-900 hover:bg-amber-500 hover:text-slate-950 text-slate-300 font-mono font-bold transition"
            >
                1/8
            </button>
            <button
            ...
            <button
                ...
                type="button"
                class="px-2 py-0.5 rounded bg-emerald-600/30 hover:bg-emerald-500 hover:text-slate-950 text-emerald-300 font-mono font-bold transition"
            >
                1ك
            </button>
        </div>
